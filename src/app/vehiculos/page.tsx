...
import { Grid, List, Search, MapPin, DollarSign, Car, Zap, Users, ChevronLeft, ChevronRight, X, Filter } from 'lucide-react';
...
function VehiculosContent() {
  ...
  const vehiculosAdvertisement = getAdvertisementForPage('vehiculos');
  const inlineAdvertisement = getInlineAdvertisementForPage('vehiculos');
  const sidebarAds = getSidebarAdvertisementsForPage('vehiculos');
  ...
  if (process.env.NODE_ENV === 'development') {
    ...
    console.log(`[Vehículos] Posts: ${currentPosts.length}, Ads inserted: ${adCount}, Inline ad:`, inlineAdvertisement);
  }
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      {/* Filter Modal - Mobile Only */}
        ...
        {/* Advertisement Modal */}
        <AdvertisementManager advertisement={vehiculosAdvertisement} />
      </div>
    </div>
  );
}
